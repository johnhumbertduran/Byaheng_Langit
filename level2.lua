...
lvl2Sound = audio.loadSound("sound/lvl2.wav")
--------------------------------------------
...
function onReplayBtnRelease(event)
	...
	storyboard.purgeScene( "rep2" )
	storyboard.gotoScene (  "rep2", "fade", 500 )
...
function scene:createScene( event )
	...
	bg1 = display.newImageRect( "im/lvl2_bg.jpg", 480, 320 )
	bg1.x = 240
	bg1.y = 160
	
	bg2 = display.newImageRect( "im/lvl2_bg.jpg", 480, 320 )
	bg2.x = bg1.width + 240
	bg2.y = 160
	...
	grcl1 = display.newImageRect( "im/ground_cloud2.png", 480, 60 )
	grcl1.x = 240
	grcl1.y = 290
	physics.addBody( grcl1, "static", { friction=100 } )

	grcl2 = display.newImageRect( "im/ground_cloud2.png", 480, 60 )
	...
	local playoptions =
{
	...
	local sheet = graphics.newImageSheet("im/character2.png", playoptions )
	...
	local holesheet = graphics.newImageSheet("im/monster_2.png", { width = 53, height =123, numFrames = 3} )
	...
	gate1 = display.newImageRect("im/gate2.png", 198, 221)
	gate1.x = 15000
...
function scene:enterScene( event )
	...
	if pauseSound.isVisible == true then
		audio.play( lvl2Sound, { channel=1, loops=-1 } )
	end
	...
	function ubraCoin()
		...
		coinRanX = math.random(2000,3500)
					...
					if(currentLevel <= 2) then
						...
						-- function NextButton()
							...
							if (score > highScore[2]) then
								if (score >= 800 and score < 1200) then
