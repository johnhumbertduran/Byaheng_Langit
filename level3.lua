...
lvl3Sound = audio.loadSound("sound/lvl3.wav")
--------------------------------------------
...
function onReplayBtnRelease(event)
	...
	storyboard.purgeScene( "rep3" )
	storyboard.gotoScene (  "rep3", "fade", 500 )
...
function scene:createScene( event )
	...
	bg1 = display.newImageRect( "im/lvl3_bg.jpg", 480, 320 )
	bg1.x = 240
	bg1.y = 160
	
	bg2 = display.newImageRect( "im/lvl3_bg.jpg", 480, 320 )
	bg2.x = bg1.width + 240
	bg2.y = 160
	...
	grcl1 = display.newImageRect( "im/ground_cloud3.png", 480, 60 )
	grcl1.x = 240
	grcl1.y = 290
	physics.addBody( grcl1, "static", { friction=100 } )

	grcl2 = display.newImageRect( "im/ground_cloud3.png", 480, 60 )
	...
	local playoptions =
{
	...
	local sheet = graphics.newImageSheet("im/character3.png", playoptions )
	...
	local holesheet = graphics.newImageSheet("im/fire2.png", { width = 53, height =123, numFrames = 3} )
	...
	gate1 = display.newImageRect("im/gate3.png", 198, 221)
	gate1.x = 20000
	...
	dark = display.newRect(240, 160, 480, 320)
	dark:setFillColor(0)
	dark.alpha = .8
...
function scene:enterScene( event )
	...
	if pauseSound.isVisible == true then
		audio.play( lvl3Sound, { channel=1, loops=-1 } )
	end
	...
	function ubraCoin()
		...
		coinRanX = math.random(1500,3500)
					...
					if(currentLevel <= 3) then
						...
						-- function NextButton()
							...
							if (score > highScore[3]) then
								if (score >= 1200 and score < 1600) then
								...
								elseif (score >= 1600 and score < 2000) then
									function star1ReturnScale()
										star1Visible2 = transition.to( star1, { transition=easing.inExpo, xScale=1, yScale=1} )
									end
								star1Visible = transition.to( star1, { transition=easing.inExpo, xScale=3, yScale=3, alpha=1, onComplete=star1ReturnScale} )
