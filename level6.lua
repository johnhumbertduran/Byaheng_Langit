...
lvl6Sound = audio.loadSound("sound/lvl6.mp3")
--------------------------------------------
...
function onReplayBtnRelease(event)
	...
	storyboard.purgeScene( "rep6" )
	storyboard.gotoScene (  "rep6", "fade", 500 )
...
function scene:createScene( event )
	...
	bg1 = display.newImageRect( "im/lvl6_bg.jpg", 480, 320 )
	bg1.x = 240
	bg1.y = 160
	
	bg2 = display.newImageRect( "im/lvl6_bg.jpg", 480, 320 )
	bg2.x = bg1.width + 240
	bg2.y = 160
	...
	grcl1 = display.newImageRect( "im/ground_cloud6.png", 480, 60 )
	grcl1.x = 240
	grcl1.y = 290
	physics.addBody( grcl1, "static", { friction=100 } )

	grcl2 = display.newImageRect( "im/ground_cloud6.png", 480, 60 )
	...
	local playoptions =
{
	...
	local sheet = graphics.newImageSheet("im/character6.png", playoptions )
	...
	local holesheet = graphics.newImageSheet("im/bird_fire.png", { width = 53, height =123, numFrames = 3} )
	...
	gate1 = display.newImageRect("im/gate6.png", 198, 221)
	gate1.x = 35000
...
function scene:enterScene( event )
	...
	if pauseSound.isVisible == true then
		audio.play( lvl6Sound, { channel=1, loops=-1 } )
	end
				...
				function checkNextButton()
					...
					if(currentLevel <= 6) then
						...
						-- function NextButton()
							...
							if (score > highScore[6]) then
								if (score >= 2400 and score < 2800) then
								...
								elseif (score >= 2800 and score < 3200) then
									function star1ReturnScale()
										star1Visible2 = transition.to( star1, { transition=easing.inExpo, xScale=1, yScale=1} )
									end
								star1Visible = transition.to( star1, { transition=easing.inExpo, xScale=3, yScale=3, alpha=1, onComplete=star1ReturnScale} )
